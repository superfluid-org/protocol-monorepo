 ...
 * 
 * Usage:
 *   npx ts-node scripts/analyze-pool-calculation-standalone.ts
 * 
 * Or with environment variables:
 *   POOL_ADDRESS=0x... RPC_URL=https://... npx ts-node scripts/analyze-pool-calculation-standalone.ts
 */
...
if (!RPC_URL) {
  ...
  console.error("Example: RPC_URL=https://polygon-rpc.com npx ts-node scripts/analyze-pool-calculation-standalone.ts");
  process.exit(1);
}
