...
- Default SuperApp `CALLBACK_GAS_LIMIT` reduced from 15M to 12M so terminate+jail can fit under EIP-7825's ~16.78M per-tx cap. Per-chain overrides (Ethereum/Scroll 3M, Avalanche 7.5M, Gnosis 8.5M) are unchanged. Host upgrades may decrease the immutable.
